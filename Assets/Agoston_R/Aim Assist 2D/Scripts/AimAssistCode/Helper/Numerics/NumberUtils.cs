...
namespace Agoston_R.Aim_Assist_2D.Scripts.AimAssistCode.Helper.Numerics
{
    ...
    public static class NumberUtils
    {
        ...
        /// <summary>
        /// Creates a vector2 from a vector3 by removing the Z axis.
        /// </summary>
        /// <param name="vector">Vector3</param>
        /// <returns>Vector2 containing X and Y axes</returns>
        ...
        /// <summary>
        /// Creates a Vector3 from a Vector2 with Z set to 0. 
        /// </summary>
        /// <param name="vector">input vector2</param>
        /// <returns>a vector3 with X and Y set to that of input, Z set to 0.</returns>
        public static Vector3 XYZ(this Vector2 vector)
        {
